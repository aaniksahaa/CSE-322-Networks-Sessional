...
main(int argc, char** argv)
{
    ...
    NodeContainer net4(c, e);
    NodeContainer net5(b, e);
    NodeContainer net6(b, d);
    NodeContainer net7(c, d);
    ...
    ripRouting.SetInterfaceMetric(d, 1, 6);
    ...
    if (printRoutingTables)
    {
        ...
        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(30.0), e, routingStream);
    ...
    PingHelper ping(Ipv4Address("10.0.7.2"));
    ...
    if (enableFlowMonitor)
    {
        flowmonHelper.SerializeToXmlFile("rip-simple-new.flowmon", false, false);
    }
