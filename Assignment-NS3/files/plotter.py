...
if __name__ == "__main__":
    TASK = 1
    plot_output_dir = f'./plots/task-{TASK}'
    create_analysis_plots('flowmon_analysis.csv', f'{plot_output_dir}/single-input-params')
    create_heatmap_plots('flowmon_analysis.csv', f'{plot_output_dir}/two-params-heatmaps')